...
export default function ListingDetailSheet({
  ...
  <div className="text-xs text-neutral-500 mt-1">* 비워두면 뷰어에 노출되지 않습니다.</div>
          ...
          <div className="grid sm:grid-cols-2 gap-3 text-sm">
            ...
            <Field label="Listings 노출">
              <label className="inline-flex items-center gap-2 text-sm">
                <input
                  type="checkbox"
                  className="h-4 w-4 rounded border-neutral-300"
                  checked={(draft as any)?.isActive !== false}
                  onChange={(e) =>
                    setDraft((prev) => ({
                      ...(prev ?? {}),
                ...
                />
                <span className="text-neutral-700">Listings에 노출</span>
              </label>
            </Field>
            <Field label="급매">
              <label className="inline-flex items-center gap-2 text-sm">
            ...
            <Field label="면적(㎡)">
              <div className="grid grid-cols-2 gap-2">
                <input
                  className="w-full border rounded px-3 py-2 text-sm"
                  placeholder="공급면적"
                  value={supplyAreaInput}
                  onChange={(e) => {
                    const val = e.target.value;
                    setSupplyAreaInput(val);
                    setDraft((prev) => ({
                      ...(prev ?? {}),
                      supplyAreaM2: numberFromInput(val),
                    }));
                  }}
                  onBlur={() => {
                    const num = numberFromInput(supplyAreaInput);
                    if (num !== undefined) setSupplyAreaInput(numberToInput(num));
                  }}
                />
                <input
                  className="w-full border rounded px-3 py-2 text-sm"
                  ...
                  onChange={(e) => {
                    const val = e.target.value;
                    setExclusiveAreaInput(val);
                    setDraft((prev) => ({
                      ...(prev ?? {}),
                      exclusiveAreaM2: numberFromInput(val),
                    }));
                  }}
                  onBlur={() => {
                    const num = numberFromInput(exclusiveAreaInput);
                    if (num !== undefined) setExclusiveAreaInput(numberToInput(num));
                  }}
                />
              </div>
            </Field>
              ...
              <div className="grid grid-cols-2 gap-2">
                <input
                  ...
                  onChange={(e) =>
                    setDraft((prev) => ({
                      ...(prev ?? {}),
                      rooms: numberFromInput(e.target.value),
                    }))
                  }
                />
                <input
                  ...
                  onChange={(e) =>
                    setDraft((prev) => ({
                      ...(prev ?? {}),
                      bathrooms: numberFromInput(e.target.value),
                    }))
                  }
                />
              </div>
            ...
            <Field label="총 층수">
              <input
                ...
                onChange={(e) =>
                  setDraft((prev) => ({
                    ...(prev ?? {}),
                    totalFloors: numberFromInput(e.target.value),
                  }))
                }
              />
            </Field>
